...
<div class="w3-container w3-padding-8 w3-lab61" id="lab61">
  ...
  <p><b>Задание 1.</b>Для всех заданий написать функцию, принимающую обычный массив в качестве аргумента и возвращающий коллекцию, как результат. Исходный массив заполнить случайными числами в диапазоне от -50 до +50. Вычесть из каждого числа наибольшее число (далее «максимум»).</p>
    ...
    <form class="w3-padding-16" action="result" method="POST">
      <input class="w3-input" type="number" name="size" placeholder="Enter storage size" min="1" max="100000" step="1" />
     <input class="w3-input w3-section" type="number" name="minLimit" placeholder="Random min" min="-100000" max="100000" step="1"/>
      <input class="w3-input w3-section" type="number" name="maxLimit" placeholder="Random max" min="-100000" max="100000" step="1"/>
